<a href="#">
  <div class="header">
    <img alt="Lusques-Python" width="100%" src="public/header.svg">
    <img alt="Lusques-Python" height="24px" width="100%" src="public/space.svg">
  </div>
  <div claas="about-me">
    <img alt="Lusques-Python" width="118px" src="public/about__me--title.svg">
    <img alt="Lusques-Python" height="8px" width="100%" src="public/space.svg">
    <img alt="Lusques-Python" width="100%" src="public/about__me--text.svg">
    <img alt="Lusques-Python" height="24px" width="100%" src="public/space.svg">
  </div>
  <div class="projects">
    <div class="row">
      <a href="https://github.com/Lusques/mjml-curriculum-template">
  ...
  <div class="footer">
    <p align="center">
      <img alt="Lusques-Python" width="540px" src="public/footer__content--text.svg">
    </p>
    <p align="center">
